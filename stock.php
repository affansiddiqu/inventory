...
<section class="container">
    <div>
        <header>Stock Adjustment</header>
        ...
        <button type="button" onclick="location.href='stock_form.php'" class="add_knittingcard_button" style="float: right;"><i class="fa fa-plus" aria-hidden="true"></i>Add Stock Adjustment</button>
    </div>
